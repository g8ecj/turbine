 ...
 */
uintptr_t fat_clear_cluster_callback(UNUSED_ARG(uint8_t*, buffer), UNUSED_ARG(offset_t, offset), UNUSED_ARG(void*, p))
{
    return 16;
}
#endif
 ...
 */
uint8_t fat_get_fs_free_16_callback(uint8_t* buffer, UNUSED_ARG(offset_t, offset), void* p)
{
 ...
 */
uint8_t fat_get_fs_free_32_callback(uint8_t* buffer, UNUSED_ARG(offset_t, offset), void* p)
{
    struct fat_usage_count_callback_arg* count_arg = (struct fat_usage_count_callback_arg*) p;
    uintptr_t buffer_size = count_arg->buffer_size;
